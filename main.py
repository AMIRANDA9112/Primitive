...
from kivy.graphics import Rectangle, Color, InstructionGroup, Ellipse
...
XP, YP = Window.width, Window.height

Window.clearcolor = (((1 / 255) * 120), ((1 / 255) * 167), ((1 / 255) * 160), 1)
...
class Cell(Widget):
    ...
    def live_color(self):
        self.ig.clear()
        self.color = Color(((1 / 255) * 47), ((1 / 255) * 51), ((1 / 255) * 25))
        self.ig.add(self.color)
        self.ig.add(self.rect)

    def death_color(self):
        self.ig.clear()
        self.color = Color(((1 / 255) * 130), ((1 / 255) * 167), ((1 / 255) * 150))
        self.ig.add(self.color)
        self.ig.add(self.rect)
...
class MyGrid(GridLayout):
    ...
    def init_page(self, dt):
        ...
        Clock.schedule_interval(self.init_game, 0.1)
